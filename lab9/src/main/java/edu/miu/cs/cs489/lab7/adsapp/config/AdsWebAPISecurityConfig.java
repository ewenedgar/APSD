package edu.miu.cs.cs489.lab7.adsapp.config;

import edu.miu.cs.cs489.lab7.adsapp.service.impl.AdsUserDetailsService;
import edu.miu.cs.cs489.lab7.adsapp.filter.JWTAuthFilter;
...
//                                    .requestMatchers("/ads/api/v1/publisher/get/**").authenticated();
                        }
                )
